  ...
  try {
    const data = [
      ...
      },
      {
        ...
        icon: <Cpu size={24} />,
        detail: language === 'de'
          ? `<span class="font-bold text-lg text-geoblue-800 block mb-3">Unsere <strong>KI-gestützten</strong> Leistungen umfassen:</span><br>• Geologische Analyse: <strong>ResNet</strong>-basierte <strong>Bilderkennung</strong> und <strong>Graph Neural Networks (GNN)</strong> zur automatischen Identifikation stratigrafischer Schichten. Aus DSM- und LiDAR-Daten generieren wir detaillierte Tektonik-Maps. Alle Ergebnisse werden durch unser Geologen-Team validiert.<br>• Automatische Bohrkern-Analyse: <strong>KI</strong>-basierte Bildklassifikation und <strong>Segmentierung</strong> von Bohrkern-Fotos/CT-Scans zur Ermittlung von Bodenklassen, Korngrößenverteilung und Porosität.<br>• CPT-Datenauswertung: Vollautomatische Ermittlung von Bodenkennwerten und Tragfähigkeiten (qc/qT-Parameter) mittels <strong>XGBoost-Regression</strong>. Clusteranalysen identifizieren Bodenzonen nach standardisierten Verfahren.<br>• Erkundungsoptimierung: Active Learning zur <strong>KI</strong>-gesteuerten Bohrpunktplanung und Kostenschätzmodelle zur Bewertung verschiedener Bohrstrategien.<br><br><strong>KI</strong> ermöglicht die automatisierte Auswertung großer Datenmengen und macht Erkundungs- und Planungsprozesse effizienter. Die menschliche Expertise bleibt dabei unverzichtbar – unsere Geologen validieren alle <strong>KI-Analyse</strong>-Ergebnisse und entwickeln die Modelle kontinuierlich weiter.`
          : `<span class="font-bold text-lg text-geoblue-800 block mb-3">Our <strong>AI-supported</strong> services include:</span><br>• Geological Analysis: <strong>ResNet</strong>-based <strong>image recognition</strong> and <strong>Graph Neural Networks (GNN)</strong> for automatic identification of stratigraphic layers. We generate detailed tectonic maps from DSM and LiDAR data. All results are validated by our team of geologists.<br>• Automated Core Analysis: <strong>AI-powered</strong> image classification and <strong>segmentation</strong> of drill core photos/CT scans to determine soil classes, grain size distribution, and porosity.<br>• CPT Data Evaluation: Fully automated determination of soil parameters and bearing capacities (qc/qT parameters) using <strong>XGBoost regression</strong>. Cluster analysis identify soil zones according to standardized procedures.<br>• Exploration Optimization: Active Learning for <strong>AI</strong>-controlled drilling point planning and cost estimation models for evaluating different drilling strategies.<br><br><strong>AI</strong> enables automated analysis of large data volumes and makes exploration and planning processes more efficient. Human expertise remains essential – our geologists validate all <strong>AI analysis</strong> results and continuously develop the models.`
      },
      {
      ...
      },
      {
        ...
        detail: language === 'de'
          ...
          : `<span class="font-bold text-lg text-geoblue-800 block mb-3">Our professional support during the construction phase offers practical assistance:</span><br>• Technical supervision of construction with focus on geotechnical aspects and critical construction phases<br>• Regular site visits and comprehensive documentation of geological conditions<br>• <strong>AI-supported</strong> analysis of deviations between predictions and actual subsoil<br>• Solution-oriented consulting for unexpected geological challenges<br>• Optimized drilling path planning for hydraulic engineering and well construction projects<br><br>This service offers decisive advantages:<br>• Reduction of construction risks and cost-intensive surprises<br>• Quick response to deviating soil conditions<br>• Technically sound decision-making basis for planners and construction management<br>• Complete documentation for potential supplements and evidence preservation`
      }
    ];
