  ...
  try {
    const data = [
      ...
      },
      {
        ...
        icon: <Cpu size={24} />,
        detail: language === 'de'
          ? `Unsere <strong>KI-gestützten</strong> Leistungen umfassen:<br><br>- Geologische Analyse: <strong>ResNet</strong>-basierte <strong>Bilderkennung</strong> und <strong>Graph Neural Networks (GNN)</strong> zur automatischen Identifikation stratigrafischer Schichten. Aus DSM- und LiDAR-Daten generieren wir detaillierte Tektonik-Maps. Alle Ergebnisse werden durch unser Geologen-Team validiert.<br>- Automatische Bohrkern-Analyse: <strong>KI</strong>-basierte Bildklassifikation und <strong>Segmentierung</strong> von Bohrkern-Fotos/CT-Scans zur Ermittlung von Bodenklassen, Korngrößenverteilung und Porosität.<br>- CPT-Datenauswertung: Vollautomatische Ermittlung von Bodenkennwerten und Tragfähigkeiten (qc/qT-Parameter) mittels <strong>XGBoost-Regression</strong>. <strong>Clusteranalysen</strong> identifizieren Bodenzonen nach standardisierten Verfahren.<br>- Erkundungsoptimierung: <strong>Active Learning</strong> zur <strong>KI</strong>-gesteuerten Bohrpunktplanung und Kostenschätzmodelle zur Bewertung verschiedener Bohrstrategien.<br><br><strong>KI</strong> ermöglicht die automatisierte Auswertung großer Datenmengen und macht Erkundungs- und Planungsprozesse effizienter. Die menschliche Expertise bleibt dabei unverzichtbar – unsere Geologen validieren alle <strong>KI-Analyse</strong>-Ergebnisse und entwickeln die Modelle kontinuierlich weiter.`
          : `Our <strong>AI-supported</strong> services include:<br><br>- Geological Analysis: <strong>ResNet</strong>-based <strong>image recognition</strong> and <strong>Graph Neural Networks (GNN)</strong> for automatic identification of stratigraphic layers. We generate detailed tectonic maps from DSM and LiDAR data. All results are validated by our team of geologists.<br>- Automated Core Analysis: <strong>AI</strong>-based image classification and <strong>segmentation</strong> of drill core photos/CT scans to determine soil classes, grain size distribution, and porosity.<br>- CPT Data Evaluation: Fully automated determination of soil parameters and bearing capacities (qc/qT parameters) using <strong>XGBoost regression</strong>. <strong>Cluster analysis</strong> identify soil zones according to standardized procedures.<br>- Exploration Optimization: <strong>Active Learning</strong> for <strong>AI</strong>-controlled drilling point planning and cost estimation models for evaluating different drilling strategies.<br><br><strong>AI</strong> enables automated analysis of large data volumes and makes exploration and planning processes more efficient. Human expertise remains essential – our geologists validate all <strong>AI analysis</strong> results and continuously develop the models.`
      },
      {
