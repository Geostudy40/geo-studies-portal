...
import { Layers, FileText, Cpu, Ruler, BarChart, Building, Database, Microscope, HardHat } from 'lucide-react';
...
export const getServices = (language: 'de' | 'en') => {
  ...
  const additionalServices = [
    { 
      title: language === 'de' ? "Datenintegration und -analyse" : "Data Integration and Analysis", 
      description: language === 'de' ? "Zusammenführung verschiedener Datenquellen für umfassende geotechnische Analysen." : "Merging different data sources for comprehensive geotechnical analyses.",
      icon: <Database size={24} />,
      detail: ""
    },
    { 
      title: language === 'de' ? "Baubegleitung" : "Construction Support", 
      description: language === 'de' ? "Geotechnische Unterstützung während der Bauphase zur Lösung unerwarteter Probleme." : "Geotechnical support during the construction phase to solve unexpected problems.",
      icon: <Building size={24} />,
      detail: ""
    },
    { 
      title: language === 'de' ? "Risikobewertung" : "Risk Assessment", 
      description: language === 'de' ? "Identifikation und Quantifizierung geotechnischer Risiken für Ihr Projekt." : "Identification and quantification of geotechnical risks for your project.",
      icon: <BarChart size={24} />,
      detail: ""
    },
    { 
      title: language === 'de' ? "Spezialuntersuchungen" : "Special Investigations", 
      description: language === 'de' ? "Maßgeschneiderte Untersuchungen für besondere geotechnische Herausforderungen." : "Customized investigations for special geotechnical challenges.",
      icon: <Microscope size={24} />,
      detail: ""
    },
  ];

  return { coreServices, additionalServices };
};
