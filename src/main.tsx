  ...
  if (rootElement) {
    rootElement.innerHTML = `
      <div style="font-family: sans-serif; text-align: center; margin-top: 50px; padding: 20px;">
        ...
        <button onclick="window.location.href='/geo-studies-portal/'" style="background: #059669; color: white; border: none; padding: 12px 24px; border-radius: 4px; cursor: pointer;">Zur Startseite</button>
      </div>
    `;
    document.body.classList.add('app-loaded');
  }
